...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['message'])){
  ...
  require_once $baseurl . "lib/emailme/emailme.class.php";
  $iemailme = new emailme();
  $iemailme->enviaremail($_POST['name'] ,$_POST['email'],$_POST['subject'],$_POST['message']);
}else{
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="contact-h-cont">
              <h1 class="cl-white">Contactar con nosotros</h1><br>
              <form method="POST" id="emailme">
                <div class="form-group cl-white" id="emailme">
                ...
                <button class="btn btn-general btn-green" role="button" onclick="document.getElementById('emailme').submit();"><i fa fa-right-arrow></i>ENVIAR MENSAJE</button>
                <!--<input  type="submit" name="enviaremail" value="Enviar">no funciona-->
              </form>
            </div>
          </div>
        </div>

...
//              "<br/>";
    ...
    function mostraerrores($errores) {
      if( count($errores) > 0 )
        {   
          echo "<div>";
...
public function validatearray($name= "",$type="") {
  $this->name= $name;
  $this->type=$type;
  if (isset($name) && isset($type))
  {
  ...
  if (isset($this->name) || isset($this->pattern) ){
    ...
    else return $this->validado=FALSE;
  }//foreach
}//if

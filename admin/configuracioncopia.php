                    ...
                    <li class="nav-item dropdown"><a id="profile" class="nav-link logout" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <ul aria-labelledby="profile" class="dropdown-menu profile">
                            ...
                            <a rel="nofollow" href="../logout.php" class="dropdown-item">
                                ...
                                <li>
                                <a rel="nofollow" href="../loginbootstrap.php" class="dropdown-item">
                                    <div class="notification">
...
======================================================-->
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            ...
            <ul class="list-unstyled">
                <li> <a href="indexbootstrap.php"><i class="icon-home"></i>Home</a></li>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="controllerdefault" aria-describedby="emailHelp" placeholder="controllerdefault" name="controllerdefault" value="<?php
                                        		foreach($colecciones as $cancion)
                                                {
                                                
                                                echo $cancion->controllerdefault;
                                                };?>">
